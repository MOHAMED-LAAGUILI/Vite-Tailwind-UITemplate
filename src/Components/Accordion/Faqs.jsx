...
function FAQItem({ question, answer, index }) {
    ...
    return (
        <motion.div
            ...
            className={`group rounded-lg border-[0.5px] border-gray-200/50 dark:border-gray-800/50 transition-all duration-200 ease-in-out ${isOpen
        ...
        >
            ...
            >
                <h3 className={`text-base font-medium transition-colors duration-200 text-left ${isOpen ? "text-gray-900 dark:text-white" : "text-gray-700 dark:text-gray-300"}`}>
                    {question}
                </h3>
                <motion.div
                    animate={{
                    ...
                    className={`p-0.5 rounded-full shrink-0 transition-colors duration-200 ${isOpen ? "text-primary" : "text-gray-400 dark:text-gray-500"}`}
                >
        ...
        <section className="py-16 w-full bg-linear-to-b from-transparent via-gray-50/50 to-transparent dark:from-transparent dark:via-white/[0.02] dark:to-transparent">
            <div className="container px-4 mx-auto">
                ...
                >
                    ...
                    <button
                        type="button"
                        className="px-4 py-2 text-sm rounded-md bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors duration-200 font-medium"
                    >
                        Contact Support
                    </button>
                </motion.div>
