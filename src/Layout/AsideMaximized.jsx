...
export default function AsideMaximized({ 
  isSidebarOpen,
  openDropdown,
  setOpenDropdown,
  asideMenuItems,
              ...
              {section.items && section.items.length > 0 ? (
                <div className="p-2 space-y-4">
                  ...
                  >
                    ...
                    {openDropdown === index ? (
                      <ChevronDown className={`h-4 w-4 transition-transform transform`} />
                    ) : (
                      <ChevronLeft className={`h-4 w-4 transition-transform transform`} />
                    )}
                  </div>
