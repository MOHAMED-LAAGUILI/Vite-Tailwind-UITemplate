  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 border-b border-gray-200 dark:border-[#1F1F23] bg-white dark:bg-[#0F0F12] relative">
      ...
      <div className="flex gap-5 absolute z-50 right-5">
        ...
        <button
          onClick={toggleTheme}
          className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-[#1F1F23] transition-colors duration-200 border"
        >
          {isDarkMode ? (
        ...
        <div className="relative z-40" ref={langDropdownRef}>
          <button
            ...
            className="h-9 w-10 mt-1 rounded-sm bg-gray-200 dark:bg-gray-700 flex items-center justify-center transition-colors duration-200"
          >
            <img
        ...
        <div className="relative" ref={profileDropdownRef}>
          <button
            ...
            className="h-10 w-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center transition-colors duration-200"
          >
            <img
