...
export const menuItems = [
 ...
 // Only show the following in development mode
 ...(ENVIRONMENT === "development" ? [
   { name: `${ENVIRONMENT}-test`, path: "/blank-page", icon: <TrendingUp className="h-4 w-4 mr-3" /> },
   { name: `${ENVIRONMENT}-resources`, path: "/tailwind-resources-page", icon: <TrendingUp className="h-4 w-4 mr-3" /> },
 ] : []),
];
